...
// garantir semnatica e seguranca em objetos
...
// questores semanticas
function MyDate() {}

// feio para Kct, td é Object, mas Object adicionando prop para uma function?
...
// --- deleteProperty
const withDelete = { user: "IgorCotrim" };
delete withDelete.user;
assert.deepStrictEqual(withDelete.hasOwnProperty("user"), false);

const withReflection = { user: "BiancaCotrim" };
